...
Also in module 3 and 4 you have to replace the Telegram bot token and chat ID with your own data to get notified.Those credentials is unique to every user that should be handle with safety and security measures.
